...
class SentimentAnalysis:
    ...
    def aggregateinformation(self, df):
        ...
        self.outputdf = self.outputdf.append(
            {'Stockname': self.stockname, 'Mentions': self.mentions, 'countpositive': countpositive,
             'countnegative': countnegative, 'countneutral': countneutral, 'verbs': verbsoccurences.verbs.tolist()},
            ignore_index=True)
